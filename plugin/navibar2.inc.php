...
//
// $Id: navibar2.inc.php,v 0.1.23 2010/06/27 18:41:00 Logue Exp $
//

defined('NAVIBAR2_DEFAULT_PARM') or define('NAVIBAR2_DEFAULT_PARM', 'top,|,edit,freeze,diff,backup,upload,reload,|,new,list,search,recent,help,|,trackback');
...
function plugin_navibar2_keyword($name)
{
	...
	case 'unfreeze':
		...
		break;
	case 'upload':
		if ($is_read && (bool)ini_get('file_uploads') && !($_page == $whatsnew || $_page == $whatsdeleted)) {
			return _navigator2($name);
		}
		break;
	case 'filelist':
