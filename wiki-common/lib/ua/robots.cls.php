 ...
 * Robot
 *
 * @copyright   Copyright (c)2010       PukiPlus! Developer Team.
 *                           2004-2006, Katsumi Saito <katsumi@jo1upk.ymt.prug.or.jp>
 * @version     $Id: robots.cls.php,v 0.6 2010/06/24 08:25:00 Logue Exp $
 ...
 *   awstats-7.0/wwwroot/cgi-bin/lib/robots.pm (Rev. 1.62)
 */
...
class robots
{
	var $robots_lib = array(
		...
		'virus[_+ ]detector' => 'Virus Detector',	// Must be before harvest
		'harvest'		=> 'Harvest',
		'htdig'			=> 'ht://Dig',
		'linkwalker'		=> 'LinkWalker',
		'lilina'		=> 'Lilina  News Aggregator',
		'lycos_'		=> 'Lycos',
		'moget'			=> 'moget',
		...
		'feedcrawl'		=> 'Metafilter Feedcrawl',
		...
		'iaskspider'	=> '新浪IaskSpider',
		'hl_ftien_spider'	=> 'HaiLiang Full Text Index English Spider',
		'iajabot'		=> 'iajaBot',
