 ...
 * @version     $Id: robots.cls.php,v 0.7 2011/12/25 20:27:00 Logue Exp $
 ...
 *   Copyright (C) 2000-2011 - Laurent Destailleur - eldy@users.sourceforge.net
...
class Robots
{
	private static $robots_lib = array(
		...
		'virus[_+ ]detector'
						=> '<a href="http://www.securecomputing.com/" title="virus_harvester@securecomputing.com; Bot home page [new window]" target="_blank">virus_detector</a>',
		'harvest'		=> 'Harvest',
		'htdig'			=> 'ht://Dig',
		...
		'ia_archiver\-web\.archive\.org'
						=> '<a href="http://web.archive.org/" title="Bot home page [new window]" target="_blank">The web archive (IA Archiver)</a>',
		...
		'hl_ftien_spider'
						=> '<a href="http://www.hylanda.com/" target="_blank">Hylanda</a>',
		...
		'udmsearch'		=> 'UdmSearch',
		'universalfeedparser'
							=> '<a href="http://feedparser.org/" title="Bot home page [new window]" target="_blank">UniversalFeedParser</a>',
		'urlck'				=> 'URL Check',
		'valkyrie'			=> 'Valkyrie',
		...
		'bncf\.firenze\.sbn\.it\/raccolta\.txt'
								=> '<a href="http://www.bncf.firenze.sbn.it/raccolta.txt" title="Bot home page [new window]" target="_blank">Biblioteca Nazionale Centrale di Firenze</a>',
		'bobby'					=> 'Bobby',
		...
		'candlelight[_+ ]favorites[_+ ]inspector'
								=> '<a href="http://www.candlelight.com/home.html" title="Candlelight_Favorites_Inspector  home page [new window]" target="_blank">Candlelight_Favorites_Inspector</a>',
		...
		'checkweb_link_validator'
								=> '<a href="http://p.duby.free.fr/chkweb.htm" title="CheckWeb link validator home page [new window]" target="_blank">CheckWeb link validator</a>',
		...
		'computer_and_automation_research_institute_crawler'
								=> '<a href="http://www.ilab.sztaki.hu/~stamas/publications/p184-benczur.html" title="Computer and Automation Research Institute Crawler home page [new window]" target="_blank">Computer and Automation Research Institute Crawler</a>',
		'converamultimediacrawler'
								=> '<a href="http://www.authoritativeweb.com/crawl/" title="ConveraMultiMediaCrawler home page [new window]" target="_blank">ConveraMultiMediaCrawler</a>',
		...
		'cse_html_validator_lite_online'
								=> '<a href="http://online.htmlvalidator.com/php/onlinevallite.php" title="CSE HTML Validator Lite Online home page [new window]" target="_blank">CSE HTML Validator Lite Online</a>',
		'cuasarbot'				=> '<a href="http://www.cuasar.com/" title="Cuasarbot home page [new window]" target="_blank">Cuasarbot</a>',
		...
		'datafountains\/dmoz_downloader'
								=> '<a href="http://infomine.ucr.edu/ " title="DataFountains/DMOZ Downloader home page [new window]" target="_blank">DataFountains/DMOZ Downloader</a>',
		'daviesbot'				=> 'DaviesBot',
		'daypopbot'				=> 'DayPop',
		...
		'extreme[_+ ]picture[_+ ]finder'
								=> '<a href="http://www.exisoftware.com/" title="Extreme_Picture_Finder home page [new window]" target="_blank">Extreme_Picture_Finder</a>',
		...
		'fast_enterprise_crawler'
								=> '<a href="http://www.fast.no/" title="FAST Enterprise Crawler home page [new window]" target="_blank">FAST Enterprise Crawler</a>',
		'fast_enterprise_crawler.*scrawleradmin\.t\-info@telekom\.de'
								=> '<a href="http://www.telekom.de/" title="FAST Enterprise Crawler * crawleradmin.t-info@telekom.de home page [new window]" target="_blank">FAST Enterprise Crawler * crawleradmin.t-info@telekom.de</a>',
		'matrix_s\.p\.a\._\-_fast_enterprise_crawler'
								=> '<a href="http://tin.virgilio.it/" title="Matrix S.p.A. - FAST Enterprise Crawler home page [new window]" target="_blank">Matrix S.p.A. - FAST Enterprise Crawler</a>',
		'fast_enterprise_crawler.*t\-info_bi_cluster_crawleradmin\.t\-info@telekom\.de'
								=> '<a href="http://www.telekom.de/" title="FAST Enterprise Crawler * T-Info_BI_cluster crawleradmin.t-info@telekom.de home page [new window]" target="_blank">FAST Enterprise Crawler * T-Info_BI_cluster crawleradmin.t-info@telekom.de</a>',
		'favicon'				=> 'FavIconizer',
		...
		'fooky\.com\/ScorpionBot'
								=> '<a href="http://www.fooky.com/scorpionbots" title="Fooky.com/ScorpionBot/ScoutOut home page [new window]" target="_blank">Fooky.com/ScorpionBot/ScoutOut</a>',
		...
		'html[_+ ]link[_+ ]validator'
								=> '<a href="http://www.lithopssoft.com/ " title="Html_Link_Validator home page [new window]" target="_blank">Html_Link_Validator</a>',
		...
		'jrtwine[_+ ]software[_+ ]check[_+ ]favorites[_+ ]utility'
								=> '<a href="http://www.jrtwine.com/Products/CheckFavs/" title="JRTwine_Software_Check_Favorites_Utility  home page [new window]" target="_blank">JRTwine_Software_Check_Favorites_Utility</a>',
		'justview'				=> 'JustView',
		...
		'kamano\.de_newsfeedverzeichnis'
								=> '<a href="http://www.kamano.de/" title="kamano.de NewsFeedVerzeichnis home page [new window]" target="_blank">kamano.de NewsFeedVerzeichnis</a>',
		...
		'microsoft[_+ ]url[_+ ]control'
								=> '<a href="http://www.webmasterworld.com/forum11/1005.htm" title="Microsoft URL Control  home page [new window]" target="_blank">Microsoft URL Control</a>',
		...
		'pear_http_request_class'
								=> '<a href="http://pear.php.net/" title="PEAR HTTP Request class home page [new window]" target="_blank">PEAR HTTP Request class</a>',
		...
		'php[_+ ]version[_+ ]tracker'
								=> '<a href="http://www.nexen.net/phpversion/bot.php" title="PHP Version Tracker home page [new window]" target="_blank">PHP version tracker</a>',
		...
		'searchguild[_+ ]dmoz[_+ ]experiment'
								=> '<a href="http://www.searchguild.com/" title="SearchGuild_DMOZ_Experiment  home page [new window]" target="_blank">SearchGuild_DMOZ_Experiment</a>',
		...
		'tcl_http_client_package'
								=> '<a href="http://www.tcl.tk/man/tcl8.4/TclCmd/http.htm" title="Tcl http client package home page [new window]" target="_blank">Tcl http client package</a>',
		...
		't\-h\-u\-n\-d\-e\-r\-s\-t\-o\-n\-e'
								=> '<a href="http://www.thunderstone.com/" title="Bot home page. Used by many. [new window]" target="_blank">T-H-U-N-D-E-R-S-T-O-N-E</a>',
		...
		'unchaos_bot_hybrid_web_search_engine'
								=> '<a href="http://www.unchaos.com/" title="UnChaos Bot Hybrid Web Search Engine home page [new window]" target="_blank">UnChaos Bot Hybrid Web Search Engine</a>',
		...
		'versus_crawler_from_eda\.baykan@epfl\.ch'
								=> '<a href="http://www.epfl.ch/Eindex.html  " title="versus crawler from eda.baykan@epfl.ch home page [new window]" target="_blank">versus crawler from eda.baykan@epfl.ch</a>',
		...
		'w3c[_+ ]css[_+ ]validator[_+ ]jfouffa'
								=> '<a href="http://jigsaw.w3.org/css-validator/" title="Bot home page [new window]" target="_blank">W3C jigsaw CSS Validator</a>',
		...
		'website[_+ ]monitoring[_+ ]bot'
								=> '<a href="http://InternetSupervision.com/UrlMonitor/3/" title="Website_Monitoring_Bot home page [new window]" target="_blank">Website_Monitoring_Bot</a>',
